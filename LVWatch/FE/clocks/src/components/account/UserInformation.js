                            ...
                            <div className="row">
                                <div className="p-3 px-5 border border-2  bg-white shadow col-12"
                                    ...
                                    <div className="row container-fluid">
                                        <span className="d-block fw-bold col-lg-4">Tên </span><span className="col-lg-8">{user?.userName}</span>
                                        <span className="d-block fw-bold col-lg-4">Email </span><span className="col-lg-8">{user?.email}</span>
                                        <span className="d-block fw-bold col-lg-4">Số điện thoại </span><span className="col-lg-8">{user?.phoneNumber}</span>
                                        <span className="d-block fw-bold col-lg-4">Địa chỉ</span><span className="col-lg-8">{user?.address}</span>
                                    </div>
                                </div>
                                <div className="p-3 px-5 border border-2  bg-white shadow col-12"
                                     style={{borderRadius: "20px"}}>
