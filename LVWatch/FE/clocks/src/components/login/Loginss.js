...
const Loginss = () => {
    ...
    useEffect(() => {
        document.title = 'LV Watch - Đăng Nhập '
    })
    const handleLogin = async () => {
        ...
        try {
            const result = await LoginService.loginUser(account);
            LoginService.addJwtTokenToLocalStorage(result.data.jwtToken);
                    ...
                    <div className="signin-signup">
                        <form action="home.html" className="sign-in-form" method="post">
                            ...
                            <div className="social-media">
                                <a href="clock/fe/clocks/src/components/login#" className="social-icon">
                        ...
                        >
                            <Form
                                action="/clock/fe/clocks/src/components/login/Login?action=registration"
