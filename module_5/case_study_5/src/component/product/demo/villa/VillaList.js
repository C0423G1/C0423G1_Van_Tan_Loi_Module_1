...
const VillaList = () => {
    ...
    const getProduct = async () => {
        setCards(await VillaService.getAllVilla(currentPage, pageSize))
    }
                    ...
                    <div key={card.id} className="col">
                        <div className="card h-100">
                            ...
                            <div className="card-icons">
                                <Link to={`/editVilla/${card.id}`}><i className="fa">&#xf044;</i></Link>
                                <i className="fa">&#xf06e;</i>
                                <Link to={`/deleteVilla/${card.id}`}><i className="material-icons">&#xe872;</i></Link>
                            </div>
                        </div>
                    </div>
                ))}
