package com.example.controller.tour;
...
import com.example.service.tour.*;
...
//            List<TourListDTO> tourList = tourService.displayDTO();
            ...
            request.getRequestDispatcher("/views/tour/2.jsp").forward(request, response);
    ...
    private void showCreateForm(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            request.getRequestDispatcher("/views/tour/create1.jsp").forward(request, response);
        } catch (ServletException | IOException e) {
            throw new RuntimeException(e);
        }
    }
    ...
    private void deleteTour(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            if (tour == null) {
                request.getRequestDispatcher("/views/tour/error.jsp").forward(request, response);
            } else {
    ...
    private void showEditForm(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            if (tour == null) {
                ...
                request.setAttribute("tour", tour);
                request.setAttribute("place", tourPlaces);
                request.getRequestDispatcher("/views/tour/edit1.jsp").forward(request, response);
            }
        } catch (ServletException | IOException e) {
            throw new RuntimeException(e);
        }
    ...
    private void showViewForm(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            if (tourListDTO == null) {
                ...
                request.getRequestDispatcher("/views/tour/view.jsp").forward(request, response);
            }
        } catch (ServletException | IOException e) {
            throw new RuntimeException(e);
        }
