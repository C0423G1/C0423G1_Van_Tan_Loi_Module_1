                        ...
                        <div class="col-12 col-lg-9 col-xl-7">
                            <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                                <div class="card-body p-4 p-md-5"
                                    ...
                                    <form method="post" action="/account?action=edit">

                                        <div class="row">
                                            <div class="col-md-6 mb-4">

                                                <div class="form-outline">
                                                    <h6 class="form-label" for="id" size="15px">ID</h6>
                                                    <input type="text" name="code" id="id"
                                                           value="${acc.getId()}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                <div class="form-outline">
                                                    ...
                                                    <input type="password" name="pass" id="phone"
                                                           value="${acc.getPassword()}"
                                                           class="form-control form-control-lg"
                                                           placeholder="Nhập mật khẩu" readonly/>
                                                </div>
                                                ...
                                                <select name="role" id="role" class="select form-control-lg" required>
                                                    <c:forEach items="${newRole}" var="role">
                                                        <option value="${role.getRoleId()}"
                                                                <c:if test="${role.getRoleId() == acc.getRole()}">selected</c:if>
