package com.example.case_study_tour.controller.booking;

import com.example.case_study_tour.model.booking.BookingDto;
import com.example.case_study_tour.model.booking.FromDto;
import com.example.case_study_tour.model.booking.RoleDto;
import com.example.case_study_tour.service.booking.BookingService;
import com.example.case_study_tour.service.booking.IBookingService;
...
//        if(count.equals(tang))
    ...
    private void showForm(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
        ...
        FromDto fromDto = service.displayFrom(customerId);
    ...
    private void checkQuantity(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
        ...
        int check = service.checkQuantity(id, 1, quantity);
...
//        request.setAttribute("check", check);
        service.success(1);
        List<BookingDto> bookings = service.display(1);
...
//        int idCustomer = Integer.parseInt(request.getParameter("idcustomer"));
        int id = Integer.parseInt(request.getParameter("id"));
        service.deleteQuantityCart(id, 1);
