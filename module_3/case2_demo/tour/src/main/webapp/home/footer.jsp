...
<footer class="bg-light" style="margin-bottom: 0;position: relative;background-color: #ffffff">
    <div class="container">
        <div class="col-md-12">
            ...
            <div class="row" style="width: 100%;margin-bottom: -50px">
                <div class="col-lg-3 my-5">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item mb-2">Email: simplebooking@gmail.com</li>
                    </ul>
                </div>
                ...
                <div class="col-lg-3 my-5">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary" style="color: #222222">Chính sách và quy định</a></li>
                    </ul>
                </div>
                <div class="col-lg-3 my-5">
                    <form>
                        <h5>Đăng ký bản tin của chúng tôi</h5>
                        <p>Thông báo hàng tháng về những gì mới và thú vị từ chúng tôi.</p>
                        <div class="d-flex flex-column flex-sm-row w-100 gap-2">
                            <label for="newsletter1" class="visually-hidden">Email address</label>
                            <input id="newsletter1" type="text" class="form-control" placeholder="Nhập Email"
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top" style="margin-bottom: -50px">
